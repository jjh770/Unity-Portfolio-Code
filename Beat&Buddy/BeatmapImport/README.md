...
| 파일 | 역할 |
|---|---|
| `OSUParser.cs` | 파일 섹션을 순회하며 메타데이터·TimingPoint·HitObject를 파싱합니다. |
| `NoteData.cs` | Beat 시각과 좌우 노트 종류를 보관하는 직렬화 데이터입니다. |
| `BGMDataSO.cs` | 오디오 클립, BPM, 난이도와 노트 배열을 묶고 에디터 임포트 기능을 제공합니다. |
